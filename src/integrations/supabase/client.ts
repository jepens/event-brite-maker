...
const getSupabaseUrl = () => {
  ...
  if (!envUrl) {
    console.warn('VITE_SUPABASE_URL environment variable is not set, using fallback');
...
const getSupabaseKey = () => {
  ...
  if (!envKey) {
    console.warn('VITE_SUPABASE_ANON_KEY environment variable is not set, using fallback');
    // Return a placeholder key that will be replaced at runtime
