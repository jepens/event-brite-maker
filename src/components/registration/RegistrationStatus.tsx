...
export function RegistrationStatus({ event, currentCount, isFull }: RegistrationStatusProps) {
  // Check if registration is closed by admin
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="flex flex-wrap items-center gap-4 pt-2">
                    ...
                    <div className="flex items-center gap-2 text-sm text-red-700">
                      ...
                      <span>Registration disabled by organizer</span>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 border-t border-red-200">
                    <p className="text-sm text-red-700">
                      <strong>What's next?</strong> Please contact the event organizer for more information or check back later if registration reopens.
                    </p>
                  </div>
                </div>
              </div>
